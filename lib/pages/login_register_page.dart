...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget _entryField2(String title, TextEditingController controller) {
    return IntlPhoneField(
      ...
      // initialCountryCode: 'ZW', // Set Zimbabwe as the default country code
      onChanged: (number) {
      ...
      validator: (PhoneNumber? number) {
        ...
        } else if (number.completeNumber == null) { // Check if completeNumber is valid
                  ...
                  Center(  // Align the text widget
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        ...
                        color: Colors.lightBlueAccent, // Adjust text color
                      ),
                    ),
                  ),
                  Row(
                  ...
                  Visibility(
                    ...
                    child: Column(
                      ...
                      children:[
                        ...
                        const SizedBox(height:20),
                        _entryField2('Whatsapp Number',_controllerNumber),
                        const SizedBox(height:20),
                        _entryField('How much equity funding you need in US\$',_controllerWish),
                        const SizedBox(height:20),
